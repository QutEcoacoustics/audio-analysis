namespace Dong.Felt
{
    ...
    public class FeatureVector
    {
        ...
        /// <summary>
        /// Gets or sets the VerticalBitVector, part of a composite  edge featurevector, representing the horizontal direction of edge(one kind of feature). 
        /// </summary>
        ...
        /// </returns>
        public static List<FeatureVector> OriginalDirectionFeatureVectors(List<PointOfInterest> poiList, int rowsCount, int colsCount, int widthOfNeighbourhood,
                                                                     int lengthOfNeighbourhood)
        {
            ...
            for (int row = 116; row < 140; row++)
            {
                for (int col = 0; col < colsCount; col++)
                {
                    ...
                    else
                    {
                        ...
                        var verticalDirection = new int[widthOfNeighbourhood];
                        var horizontalDirection = new int[lengthOfNeighbourhood];
                        ...
                        for (int rowNeighbourhoodIndex = 0; rowNeighbourhoodIndex < widthOfNeighbourhood; rowNeighbourhoodIndex++)
                        {
                            for (int colNeighbourhoodIndex = 0; colNeighbourhoodIndex < lengthOfNeighbourhood; colNeighbourhoodIndex++)
                            {
                        ...
                        //       }
                        //   }       
                        result.Add(new FeatureVector(new Point(row, col)) { HorizontalBitVector = horizontalDirection, VerticalBitVector = verticalDirection });
                    } 
                }
            }
            return result;
        ...
        //public static int[,] FractionFeatureVector(List<PointOfInterest> poiList, int rows, int cols, int herzScale, double timeScale)
        //{
        //    var SecondToMillionSecondUnit = 1000;

        //    var yCountInEachSlice = herzScale;  // 13 pixels  500
        //    var xCountInEachSlice = (int)(timeScale * SecondToMillionSecondUnit);  // 13 pixels  0.15 second
        //    var yradiusOfSearchArea = yCountInEachSlice / 2;
        //    var xradiusOfSearchArea = xCountInEachSlice / 2;

        //    var rowsCount = (int)(cols / xCountInEachSlice);
        //    var colsCount = rows / yCountInEachSlice;
        //    var result = new int[colsCount, rowsCount];
        ...
        //            var verticalDirection = new int[rowsCount];
        //            var horizontalDirection = new int[colsCount];
        //            //var positiveDiagonalDirection = new int[2 * sizeOfNeighbourhood - 1];
        //            //var negativeDiagonalDirection = new int[2 * sizeOfNeighbourhood - 1]; 
        //            for (int i = -yradiusOfSearchArea; i <= yradiusOfSearchArea; i++)
        //            {
        //                for (int j = -xradiusOfSearchArea; j <= xradiusOfSearchArea; j++)
        //                {
        //                    // check boundary of index 
        //                    if (StatisticalAnalysis.checkBoundary(row + yradiusOfSearchArea, col + xradiusOfSearchArea, rows, cols))
        //                    {
        //                        if ((Matrix[row + yradiusOfSearchArea, col + xradiusOfSearchArea] != null) && Matrix[row + yradiusOfSearchArea, col + xradiusOfSearchArea].OrientationCategory == (int)Direction.East)
        //                        {
        //                            horizontalDirection[row + yradiusOfSearchArea]++;
        //                        }
        //                    }
        //                }
        //            }
        ...
        //                for (int j = -xradiusOfSearchArea; j <= xradiusOfSearchArea; j++)
        //                {
        //                    if (StatisticalAnalysis.checkBoundary(row + xradiusOfSearchArea, col + yradiusOfSearchArea, rows, cols))
        //                    {
        //                        if ((Matrix[row + xradiusOfSearchArea, col + yradiusOfSearchArea] != null) && Matrix[row + xradiusOfSearchArea, col + yradiusOfSearchArea].OrientationCategory == (int)Direction.North)
        //                        {
        //                            verticalDirection[row + yradiusOfSearchArea]++;
        //                        }
        //                    }
        //                }
        //            }
