function template_matching_using_distance_koala(name, file_path_audio, file_path_acoustic_events, results_path, int_thresh, small_events_thresh, xlsfile, template_name)
...
% centroids expressed as pixel values (+/-ive integers)
