% MIML kNN for frog call classificatioon
...
csv1075Folder = '.\09-10\1075\content\*.csv';
csv1075FolderName = '.\09-10\1075\content\fileName';
...
for indexA = 1:len1075
    ...
    contentFeature = csvread(csvPath);
    bag1075(indexA, 1) = num2cell(contentFeature, [1 2]);
    
end

csv1078Folder = '.\09-10\1078\content\*.csv';
csv1078FolderName = '.\09-10\1078\content\fileName';
...
for indexA = 1:len1078
    ...
    contentFeature = csvread(csvPath);
    bag1078(indexA, 1) = num2cell(contentFeature, [1 2]);
    
end


csv1079Folder = '.\09-10\1079\content\*.csv';
csv1079FolderName = '.\09-10\1079\content\fileName';
...
for indexA = 1:len1079
    ...
    contentFeature = csvread(csvPath);
    bag1079(indexA, 1) = num2cell(contentFeature, [1 2]);
...
num_ref=10; % Setting the number of references considered by MIML-kNN
num_citer=20; % Setting the number of citers considered by MIML-kNN

[Weights,tr_time]=MIML_kNN_train(train_bags,train_target,num_ref,num_citer); % Calling the training function of MIML-kNN

[HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels,te_time]=MIML_kNN_test(train_bags,train_target,test_bags,test_target,num_ref,num_citer,Weights); % Calling the testing function of MIML-kNN
