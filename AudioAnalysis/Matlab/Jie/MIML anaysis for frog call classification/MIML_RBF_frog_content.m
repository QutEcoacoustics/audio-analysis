...
ratio=0.1; % Setting the fraction parameter of MIMLRBF
mu=0.6; % Setting the scaling factor of MIMLRBF

[Centroids,Sigma_value,Weights,tr_time]=MIML_RBF_train(train_bags,train_target,ratio,mu); % Calling the training function of MIMLRBF

[HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels,te_time]=MIML_RBF_test(test_bags,test_target,Centroids,Sigma_value,Weights); % Calling the testing function of MIMLRBF
