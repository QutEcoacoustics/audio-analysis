...
% [AcousSig,frequency,timeframe,OutStartH,OutEndH,OutStartL,OutEndL,HFrq,LFrq]=WhipClustering(WhipFrequencydB1,WhipFramedB1,WhipFrequencydB2,WhipFramedB2,WhipFrequencydB3,WhipFramedB3,fs,window);
