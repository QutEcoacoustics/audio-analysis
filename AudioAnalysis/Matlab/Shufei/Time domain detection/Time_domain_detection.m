...
[freqBin1,FrameZero1,freqBindB1,FrameZerodB1,WhipFrequencydB1,WhipFramedB1]=SignalMarkedInSpectrogram(window,S1,L,fs,I1,F);
[freqBin2,FrameZero2,freqBindB2,FrameZerodB2,WhipFrequencydB2,WhipFramedB2]=SignalMarkedInSpectrogram(window,S2,L,fs,I1,F);
[freqBin3,FrameZero3,freqBindB3,FrameZerodB3,WhipFrequencydB3,WhipFramedB3]=SignalMarkedInSpectrogram(window,S3,L,fs,I1,F);


% [freqBin1,FrameZero1,freqBindB1,FrameZerodB1]=SignalMarkedInSpectrogram(window,S1,L,fs,I1,F);
% [freqBin2,FrameZero2,freqBindB2,FrameZerodB2]=SignalMarkedInSpectrogram(window,S2,L,fs,I1,F);
% [freqBin3,FrameZero3,freqBindB3,FrameZerodB3]=SignalMarkedInSpectrogram(window,S3,L,fs,I1,F);
...
% showImage1(c,I1,freqBindB1,FrameZerodB1,freqBindB2,FrameZerodB2,freqBindB3,FrameZerodB3,T,F,15,2);
% showImage1(c,I1,freqBin1,FrameZero1,freqBin2,FrameZero2,freqBin3,FrameZero3,T,F,16,1);
