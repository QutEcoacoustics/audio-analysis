...
namespace AnalysisPrograms
{
    public class Crow
    {
        ...
        {
            string title = "# FOR DETECTION OF CROW CALLS";
                                                                                         ...
                                                                                         int minFormantgap, int maxFormantgap, double minDuration, double maxDuration)
        {
            ...
            //subMatrix = MatrixTools.FilterMatrixRows(subMatrix);
            ...
            List<AcousticEvent> predictedEvents = AcousticEvent.ConvertScoreArray2Events(scoreArray, minHz, maxHz, sonogram.FramesPerSecond, binWidth,
