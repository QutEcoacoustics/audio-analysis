...
namespace AnalysisPrograms
{
    class EditFeltTemplate
    {
        ...
        //CURLEW
        //edittemplate_felt "C:\SensorNetworks\WavFiles\Curlew\Curlew2\West_Knoll_-_St_Bees_20080929-210000.wav"              C:\SensorNetworks\Output\FELT_CURLEW\FELT_CURLEW2_Params.txt  FELT_Curlew2
        ...
        public static void Dev(string[] args)
        {
            ...
            string targetPath      = outputDir + targetName + "_editedtarget.txt";
            ...
            //Save binary and trinary versions of the edited image
            Log.WriteLine("#################################### WRITE THE BINARY TEMPLATE ##################################");
            double threshold = 0.2;
            int intThreshold = (int)(255 - (threshold * 255));
            ...
            int neighbourhood = 9; //the do not care neighbourhood
            ...
            //string biFile = outputDir + targetName + "_target_edit2binary.bmp";
            //int[,] m = ReadImage2BinaryMatrix(biFile);
            //FileTools.WriteMatrix2File(m, biFile + ".txt");
            //string triFile = outputDir + targetName + "_target_edit2trinary.bmp";
            //m = ReadImage2TrinaryMatrix(triFile);
            //FileTools.WriteMatrix2File(m, triFile + ".txt");

            // Save extracted event as a matrix of SPR symbols
            double templateThreshold = 0.2;
            double[,] matrix = ImageTools.GreyScaleImage2Matrix(bitmap);
            char[,] spr = Target2SymbolicTracks(matrix, templateThreshold);
