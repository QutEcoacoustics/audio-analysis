...
namespace AnalysisPrograms
{
    public class LSKiwi2 : IAnalysis
    {
        ...
        {
            string recordingPath = @"C:\SensorNetworks\WavFiles\Kiwi\Planitz.wav";
            string configPath    = @"C:\SensorNetworks\Output\Kiwi\Kiwi.cfg";
            string outputDir     = @"C:\SensorNetworks\Output\Kiwi\";
