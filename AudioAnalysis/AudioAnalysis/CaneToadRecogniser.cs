...
namespace AudioAnalysis
{
    class CaneToadRecogniser
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n\n###############################################################################################");
            sb.Append("\n\n###############################################################################################\n");
            int totalCount = accumulatedEvents.Count;
            Console.WriteLine("TOTAL EVENT COUNT = " + totalCount);
            sb.Append("TOTAL EVENT COUNT = " + totalCount + "\n");
            StringBuilder sb2 = new StringBuilder();
            AcousticEvent.WriteEvents(accumulatedEvents, ref sb2);
            FileTools.WriteTextFile(outputFolder + eventsFile, sb2.ToString());
