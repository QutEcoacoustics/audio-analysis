DirName <- "C:\\Work\\RHome\\Groote_Projects\\Indices\\ENT"
...
dir.create(paste(DirName2, "Lrothii_ENT", sep="\\"))

#if transposed

  #dir.create(paste(DirName, "transposed_LrothiiENT", sep="\\"))
...
#use the following if transposed
  ...
  new_filename <- paste("ENT_", indices_file)
  output_csv <- paste(DirName2, "\\Lrothii_ENT\\", new_filename, ".csv", sep = "")
