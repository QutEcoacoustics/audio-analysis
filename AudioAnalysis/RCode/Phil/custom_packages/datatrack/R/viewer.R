...
#' Helper function for dev: saves data from datatrack to the dviewer data source
...
.SaveDemoVisData <- function (test_data, path.to.package.source = '../../custom_packages/dviewer/data') {
