...
# path to the csv containing the list of tags. 
# To Do: delete this because we are reading directly from the MySql database now
#g.species.path <- file.path(g.source.dir, 'NW/speciesminutes/query_result.csv');
...
g.events.col.names <- c('filename','site','date','start.sec','file.start.sec','duration','bottom.freq','top.freq');
