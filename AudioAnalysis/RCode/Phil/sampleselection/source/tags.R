GetTags <- function (fields = c('start_date', 'start_time', 'site', 'species_id')) {
  
  # selects the tags for the appropriate sites, between the appropriate date times
  ...
  #need to round start time down to the nearest 10 mins and end time up to the nearest 10 mins. 
  
  start.date.time <- paste0("'",g.start.date," ",start.time,"'");
  end.date.time <- paste0("'",g.end.date," ",end.time,"'");
  
  #convert vector of sites to comma separated list of quoted strings between parentheses
