...
OutputForVis <- function (fn, events, species.mins, data = NULL, path = "~/Google Drive/0qut/papers_by_me/cluster_quality_evaluation/b-cubed/data/", as.json = TRUE, as.txt = FALSE, max.rows = NULL) {
