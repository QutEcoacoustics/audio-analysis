...
plotQuartile (propertiesEE3$Q25,propertiesEE4$Q25,
              ...
              propertiesEE3$cent,propertiesEE4$cent,pos1, myFiles[3],
              timeLabels1)
...
pdf("EE2.pdf", width=11.69, height=8.27)
par(mfrow=c(3,1)) # set layout
par(mar=c(4.3, 4.6, 0.7, 2.1)) # set margins
