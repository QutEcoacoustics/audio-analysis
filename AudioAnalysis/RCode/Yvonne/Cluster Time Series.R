...
vec <- vec[,2]
vec <- read.csv("Clusterjlist.csv", header =T)

# clusters <- unname(kmeansObj$cluster)
clusters <- vec$unname.kmeansObj.cluster.
clusters <- vec[10081:20160,]
#centers <- kmeansObj$centers

indices <- read.csv("C:\\Work\\CSV files\\GympieNP1_new\\2015_06_21\\Towsey_Summary_Indices_Gympie NP1 20150622-000000+1000to20150628-064559+1000.csv", header = T)
...
#################################
clusters <- vec[1:10080,]
clusters <- vec[10081:20160,]
clusters <- vec[20161:30240,]
clusters <- vec[30241:40320,]
clusters <- vec[40321:50400,]
clusters <- vec[50401:60480,]
clusters <- vec[60481:70560,]
clusters <- vec[70561:80640,]
clusters <- vec[80641:90720,]
clusters <- vec[90721:100800,]
clusters <- vec[100801:110880,]
clusters <- vec[110881:120960,]
clusters <- vec[120961:131040,]
clusters <- vec[131041:141120,]
clusters <- vec[141121:151200,]

site <- "WoondumNP"
clusters <- vec[159841:169920,] #Week1
clusters <- vec[169921:180000,] #Week2
clusters <- vec[180001:190080,] #Week3
clusters <- vec[190081:200160,] #Week4
clusters <- vec[200161:210240,] #Week5
clusters <- vec[210241:220320,] #Week6
clusters <- vec[220321:230400,] #Week7
clusters <- vec[230401:240480,] #Week8
clusters <- vec[240481:250560,] #Week9
clusters <- vec[250561:260640,] #Week10
clusters <- vec[260641:270720,] #Week11
clusters <- vec[270721:280800,] #Week12
clusters <- vec[280801:290880,] #Week13
clusters <- vec[290881:300960,] #Week14
clusters <- vec[300961:311040,] #Week15
...
# rename file here
file <- paste("Cluster Time Week15", site, 
...
for (i in (n+1):(length(clusters)-(n+1))) {
  ...
  # what are the unique clusters in the time interval?
  lengthOfSeries <- length(unique(clusterSet))
