...
for(i in 1:length(num_clus)) {
  ...
  clust <- kmeans_centers[a,2:ncol(kmeans_centers)]
...
clusters1$border[2] <- leg_col$hex[7]
clusters1$border[3] <- leg_col$hex[6]
clusters1$border[4] <- leg_col$hex[1]
clusters1$border[7] <- leg_col$hex[7]
clusters1$border[8] <- leg_col$hex[7]
clusters1$border[13] <- leg_col$hex[1]
clusters1$border[14] <- leg_col$hex[5]
clusters1$border[22] <- leg_col$hex[6]
clusters1$border[26] <- leg_col$hex[6]
clusters1$border[28] <- leg_col$hex[7]
clusters1$border[30] <- leg_col$hex[7]
clusters1$border[31] <- leg_col$hex[1]
clusters1$border[32] <- leg_col$hex[1]
clusters1$border[34] <- leg_col$hex[6]
clusters1$border[36] <- leg_col$hex[5]
clusters1$border[39] <- leg_col$hex[5]
clusters1$border[40] <- leg_col$hex[7]
clusters1$border[45] <- leg_col$hex[7]
clusters1$border[48] <- leg_col$hex[7]
clusters1$border[49] <- leg_col$hex[7]
clusters1$border[50] <- leg_col$hex[1]
clusters1$border[51] <- leg_col$hex[7]
clusters1$border[52] <- leg_col$hex[7]
clusters1$border[57] <- leg_col$hex[6]
...
plot(clusters1$points1, 
     ...
     xlab = "x configuration",ylab = "y configuration",
...
a <-legend("topright", title="Features", 
