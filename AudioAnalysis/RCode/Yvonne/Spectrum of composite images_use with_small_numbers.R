# This code is only to be used with small numbers of minutes < 1000
# runs analysis over whole cluster.list, to use with large cluster.lists use
# the code called "Spectrum of composite images.R"
...
cluster.no <-26
name.as.char <- "Sept_10am_C26_Gym_Woondum"
name.as.char1 <- "Sept_10am_C26_Gympie"
name.as.char2 <- "Sept_10am_C26_Woondum"
Sept_10am_C26_Woon$list_Woondum <- Sept_10am_C26_Woon$list_Woondum + 111*1440
name <- c(Sept_10am_C26_Gym$list_Gympie, Sept_10am_C26_Woon$list_Woondum)
