...
##############################
clusters <- read.csv("hybrid_clust_knn_17500_3.csv",header=T)
...
par(mar=c(6,6,2,2))
plot(a, main = "GympieNP k17500, k30 k3", cex.lab=2, cex.axis=2, 
     cex=1.5, cex.main=2)
dev.off()

a <- hclust(dist(all.Woondum.averages),"ward.D2")
png("hclust WoondumNP 17500 k30 3.png",width=1500,height=1000)
par(mar=c(6,6,2,2))
plot(a, main = "WoondumNP k17500, k30 k3", cex.lab=2, cex.axis=2, 
     cex=1.5, cex.main=2)
dev.off()

a <- hclust(dist(all.averages),"ward.D2")
png("hclust both sites 17500 k30 3.png",width=1500,height=1000)
par(mar=c(6,6,2,2))
plot(a, main = "Gympie and Woondum k17500, k30 k3", cex.lab=2, cex.axis=2, 
     cex=1.5, cex.main=2)
dev.off()
