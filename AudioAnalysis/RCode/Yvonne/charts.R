...
png("Comparison of 4 6 24 hr fingerprints.png", height = 600,width = 600)
par(mar=c(5,5,3,2),cex=1.3, cex.axis=1.5, cex.lab=1.5)
plot(x, hclust_4hour, type = "b",pch=17, ylim = c(1.3,2.3),
     ylab = "I3D distance",xlab = "",
     main = "hclust comparison of 4,6 & 12 fingerprints, ward.D2 
     (twenty-four hour fingerprints - 12 days)",
...
#plot(x,hybrid_4000_4hour, type = "b",
#     ylim = c(1.3,2.3),pch=24, 
#     ylab = "", xlab = "")
#par(new=TRUE)
plot(x,hybrid_1000_6hour, type = "b",
     ylim = c(1.2,2.3),pch=19,
     ylab = "I3D.distance",
     xlab = "k", lwd=1.5,
     yaxt="n",main="6 hour")
par(new=TRUE)
plot(x,hybrid_2000_6hour, type = "b",
     ylim = c(1.2,2.3),pch=17, 
     ylab = "", xlab = "",lwd=1.5,
     yaxt="n",xaxt="n")
par(new=TRUE)
plot(x,hybrid_3000_6hour, type = "b",
     ylim = c(1.2,2.3),pch=15, 
     ylab = "", xlab = "",lwd=1.5,
     yaxt="n",xaxt="n")
#par(new=TRUE)
#plot(x,hybrid_4000_6hour, type = "b",
#     ylim = c(1.3,2.3),pch=24, 
#     ylab = "", xlab = "")

plot(x,hybrid_1000_24hour, type = "b",
     ylim = c(1.2,2.3),pch=19,
     ylab = "I3D.distance",
     xlab = "k",lwd=1.5,
     yaxt="n",main="24 hour")
par(new=TRUE)
plot(x,hybrid_2000_24hour, type = "b",
     ylim = c(1.2,2.3),pch=17, 
     ylab = "", xlab = "",lwd=1.5,
     yaxt="n",xaxt="n")
par(new=TRUE)
plot(x,hybrid_3000_24hour, type = "b",
     ylim = c(1.2,2.3),pch=15, 
     ylab = "", xlab = "",lwd=1.5,
     yaxt="n",xaxt="n")
mtext("Comparison of 4, 6 and 24 hour fingerprints (12 days)",
      side=3,outer=TRUE,cex=1.5,line =0.9)
mtext("k",side=1,line=1.2,outer=TRUE,cex=1.3)
mtext("I3D distance",side=2,outer=TRUE,
      line=3.5,cex=1.3)
dev.off()
...
png("kmeans(12days).png")
plot(x,y,type = "b",xlab = "k",
     ylab = "I3D distance",
     main = "kmeans 
     (twenty-four hour fingerprints -12 days)",xlim=c(0,30))
dev.off()
####################################
...
png("hclust 12 day.png",height = 600,width = 600)
par(mar=c(5,5,3,2),cex=1.3, cex.axis=1.5, cex.lab=1.5)
plot(x,I3D.average,type = "b",pch=17, ylim = c(1.3,1.85),
     ylab = "I3D distance",xlab = "",
     main = "hclust comparison of average and ward.D2 
     (twenty-four hour fingerprints - 12 days)",
     cex=1.3,cex.axis=1.5)
par(new=TRUE)
...
legend("bottomright",pch = c(17, 19),
       c("average","ward.D2"),bty = "n",cex=1.5)
dev.off()

####################################
# Plotting hybrid method (12 days)
####################################
x <- c(5,10,15,20,22,24,25,26,28,30)
hybrid1000 <- c(1.915,1.292,1.252,1.735,1.521,1.519,1.527,1.471,1.482,1.484)
hybrid1500<- c(1.789,1.292,1.305,1.334,1.419,1.416,1.414,1.478,1.414,1.402)
hybrid2000 <- c(1.802,1.279,1.314,1.696,1.450,1.450,1.433,1.429,1.449,1.456)
hybrid2500<- c(1.858,1.354,1.320,1.357,1.384,1.363,1.355,1.349,1.482,1.493)
hybrid3000 <- c()
hybrid3500<- c()

png("hclust 12 day.png",height = 600,width = 600)
par(mar=c(5,5,3,2),cex=1.3, cex.axis=1.5, cex.lab=1.5)
plot(x,hybrid1000,type = "b",pch=17, ylim = c(1.1,2.1),
     ylab = "I3D distance",xlab = "",
     main = "hybrid comparison different k1 values 
     (twenty-four hour fingerprints - 12 days)",
     cex=1.3,cex.axis=1.5)
par(new=TRUE)
plot(x,hybrid1500,type = "b",pch=19,ylim = c(1.1,2.1),
     yaxt="n",ylab = "",xlab = "k",cex=1.3,cex.axis=1.5)
legend("bottomright",pch = c(17, 19),
       c("hybrid1000","hybrid1500"),bty = "n",cex=1.5)
dev.off()
...
plot(times1c, pch=20, xlab = "Observation number", 
     ylab = "Cluster 1 times (in hours)",xaxt="n")
plot(times1c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "")
rose.diag(times1c, bins = 24, col="darkgrey",
...
plot(times2c, pch=20, xlab = "Observation number", 
     ylab = "Cluster 1 times (in hours)",xaxt="n")
plot(times2c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "")
...
times3c <- circular(times3, type= "angles", units = "hours",
                    template = "clock24",modulo = "2pi")
plot(times3c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
rose.diag(times3c, bins = 24, col="darkgrey",
          cex=0, prop = 1.5, add = T,ylim=c(-1.5,1.5),
          xaxt="n")
...
#     ylab = "Cluster 1 times (in hours)",xaxt="n")
plot(times4c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
plot(times5c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
...
#  par(mfrow=c(5,2),oma=c(0,0,0,0),mar=c(0,0,0,0),cex=1)
  ...
  rose.diag(times5c, bins = 24, col="darkgrey",
...
plot(times6c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times7c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times8c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times9c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1,1),xlim = c(-0.8,3.2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
rose.diag(times9c, bins = 24, col="darkgrey",
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times10c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
rose.diag(times10c, bins = 24, col="darkgrey",
          cex=0, prop = 1.5, add = T,ylim=c(-1.5,1.5),
          xaxt="n")
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times11c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times12c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
rose.diag(times12c, bins = 24, col="darkgrey",
          cex=0, prop = 1.5, add = T,ylim=c(-1.5,1.5),
          xaxt="n")
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times13c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
...
#     ylab = "Cluster 6 distribution (in hours)",xaxt="n")
plot(times14c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
rose.diag(times14c, bins = 24, col="darkgrey",
          cex=0, prop = 1.5, add = T,ylim=c(-1.5,1.5),
          xaxt="n")
...
times15c <- circular(times15, type= "angles", units = "hours",
                     template = "clock24",modulo = "2pi")
plot(times15c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
rose.diag(times15c, bins = 24, col="darkgrey",
          cex=0, prop = 1.5, add = T,ylim=c(-1.5,1.5),
          xaxt="n")
...
times16c <- circular(times16, type= "angles", units = "hours",
                     template = "clock24",modulo = "2pi")
plot(times16c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
times17c <- circular(times17, type= "angles", units = "hours",
                     template = "clock24",modulo = "2pi")
plot(times17c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
times18c <- circular(times18, type= "angles", units = "hours",
                     template = "clock24",modulo = "2pi")
plot(times18c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
times19c <- circular(times19, type= "angles", units = "hours",
                     template = "clock24",modulo = "2pi")
plot(times19c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
times20c <- circular(times20, type= "angles", units = "hours",
                     template = "clock24",modulo = "2pi")
plot(times20c, bin=120, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
times21c <- circular(times21, type= "angles", units = "hours",
                     template = "clock24",modulo = "2pi")
plot(times21c, bin=121, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
...
plot(times24c, bin=124, stack=TRUE, sep= 0.035, shrink=1,
     ylim = c(-1.5,1.5),xlim = c(-2,2),xaxt="n",cex.axis=0.5,
     xaxt="n",xlab = "", pch=20)
rose.diag(times24c, bins = 24, col="darkgrey",
          cex=0, prop = 1.5, add = T,ylim=c(-1.5,1.5),
          xaxt="n")
