...
qgraph(datafr,node.width=0.6,asize=1.6,  
       ...
       edge.color="black", maximum=800, color=c("lightyellow2",
      "lightyellow2","lightyellow2",
      "lightyellow2","lightyellow2",
      "lightyellow2","grey70","grey70",
      "grey70","lightyellow2","grey70","grey70",
      "grey70","grey70","lightyellow2",
      "lightyellow2","lightyellow2",
      "lightyellow2","grey70","grey70",
      "lightyellow2","orange","lightyellow2",
      "lightyellow2","grey70","lightyellow2",
      "lightyellow2"), edge.labels=T,legend=T,
      nodeNames=nodeNames)
mtext(paste("                                                                                                                                                    ",
            site),side = 1, line = 18, cex = 0.8)
nodeNames <- c("day","night")
qgraph(datafr, node.width=0.6,asize=1.6,  
       bidirectional=FALSE, nNodes=27, #threshold=10, 
       normalize=TRUE,cut=20, edge.label.cex=0.8, 
...
# Day5 
####################
A <- unname(data[2:(length(data[,5])-1),2])
B <- unname(data[3:length(data[,5]), 2])
g1 <- data.frame(A=A,B=B)
df <- NULL
datafr <- NULL
