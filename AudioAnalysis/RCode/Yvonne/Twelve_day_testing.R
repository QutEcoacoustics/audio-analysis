...
write.csv(twentyfour_hour_table_20, paste(csv.name, "_k100_24hour_full111days.csv", sep = ""),
          row.names = F)
####################################################
# Saving the Hybrid 2 hour files
####################################################
...
#          row.names = F)
#write.csv(two_hour_table_2, paste(csv.name, "_k15_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_3, paste(csv.name, "_k25_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_4, paste(csv.name, "_k35_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_5, paste(csv.name, "_k45_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_6, paste(csv.name, "_k55_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_7, paste(csv.name, "_k65_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_8, paste(csv.name, "_k75_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_9, paste(csv.name, "_k85_2hour_full111days.csv", sep = ""),
#          row.names = F)
#write.csv(two_hour_table_10, paste(csv.name, "_k95_2hour_full111days.csv", sep = ""),
#          row.names = F)