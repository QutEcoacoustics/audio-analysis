// <copyright file="StructureTensor.cs" company="QutEcoacoustics">
...
namespace TowseyLibrary
{
    ...
    public static class StructureTensor
    {
        ...
        public static double[] CalculateEigenValues(double[,] M)
        {
            ...
            eigenValues[0] = (traceSTM / 2) + (Math.Sqrt(discriminantSTM) / 2);
            eigenValues[1] = (traceSTM / 2) - (Math.Sqrt(discriminantSTM) / 2);
            return eigenValues;
        }
