...
namespace AudioAnalysisTools
{
    ...
    public class SpectralTrack
    {
        ...
        // ################################################################
        // THE CODE BELOW HERE BELONGED TO THE OLD SPECTRALTRACK CLASS.
        // IT CAN BE DELETED ONCE THE NEW SPECTRALTRACK CLASS IS STABLE.
...
{
    get
    { // calculate periodicity from midpoint of the array
