...
namespace AudioAnalysisTools.DSP
{
    ...
    public class DSP_IIRFilter
    {
        ...
        public static Tuple<int, double[], double[], double> CreateFilter(string filterName)
        {
            ...
            {
                return Chebyshev_Highpass_400();
            }
            else
            if (filterName.StartsWith("Chebyshev_Lowpass_1000"))
            {
                return Chebyshev_Lowpass_1000();
            }
            else
            if (filterName.StartsWith("Chebyshev_Lowpass_3000"))
            {
                return Chebyshev_Lowpass_3000();
            }
            else
            if (filterName.StartsWith("Chebyshev_Lowpass_5000"))
            {
