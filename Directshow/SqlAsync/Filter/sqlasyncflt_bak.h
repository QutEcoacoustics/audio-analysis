...
class CSqlAsyncFilter : public CAsyncReader, public IFileSourceFilter, public ISqlFileSource
{
public:
    CSqlAsyncFilter(LPUNKNOWN pUnk, HRESULT *phr) :
